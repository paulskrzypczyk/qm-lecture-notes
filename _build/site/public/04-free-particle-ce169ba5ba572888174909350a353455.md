...
In the previous section, we saw that under the assumption of a separable solution, we can reduce the problem of solving the Schr\"odinger equation [](#e-SE), to that of solving the the TISE \eqref{e:TISE}. We will make this assumption here, and study the consequences.
