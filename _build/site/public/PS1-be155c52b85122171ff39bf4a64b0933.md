...
1. Consider the following wavefunction,
  ...
  \end{equation}
   1.1. Show that this is a normalised wavefunction. 
   1.1.  Sketch the wavefunction $\Psi(x,t_0)$ and the probability density $P(x,t_0)$.
   1.1. What is the probability amplitude at $x = \frac{1}{2}$. 
   1.1. Where is the probability density to find the particle largest? What is the probability density there? 
