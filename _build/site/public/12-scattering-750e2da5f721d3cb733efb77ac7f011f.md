...
\end{align*} where we use $|j_\mathrm{refl}(x,t_0)|$, since by the physics of the problem, this is a negative quantity. Substitute in the expressions from part 1. and part 2. to show that we recover the expressions [](#e-R) and [](#e-T) from the main text.
