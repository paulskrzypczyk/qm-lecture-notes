...
where $a$ and $p_0$ are arbitrary real constants. 
	...
	\item Evaluate this expression for the Gaussian wavepacket $\Psi(x)$. 
	
	\noindent \hint{You may want to use the following results for Gaussian integrals in order to help carry out this calculation:
		\begin{align*}
