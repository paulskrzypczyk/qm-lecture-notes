...
To summarise, a wavefunction of the form [](#e-wavepacket) is a **normalised solution} to the Schr\"odinger equation whenever [](#e-ck-norm) is satisfied. We thus see that the superposition principle allows us to go from the unnormalised separable solutions [](#e-free-sep) to normalised  inseparable ones. 
