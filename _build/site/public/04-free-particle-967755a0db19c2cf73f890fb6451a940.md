...
To summarise, a wavefunction of the form [](#e-wavepacket) is a **normalised solution} to the Schr\"odinger equation whenever \eqref{e:ck norm} is satisfied. We thus see that the superposition principle allows us to go from the unnormalised separable solutions \eqref{e:free sep} to normalised  inseparable ones. 
