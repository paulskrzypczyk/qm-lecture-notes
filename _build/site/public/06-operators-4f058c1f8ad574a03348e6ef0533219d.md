...
````{important} Video: _Operators I_ 
:class: dropdown
```{iframe} https://mediasite.bris.ac.uk/Mediasite/Play/32dfb1bf561a4854bafdbb82849ce5001d
:width: 100%
```
````
...
````{important} Video: _Derivation of average momentum_ 
:class: dropdown
```{iframe} https://mediasite.bris.ac.uk/Mediasite/Play/c33a059b62244354b69fc80ddcee44911d
:width: 100%
```
````
...
````{important} Video: _Operators II_ 
:class: dropdown
```{iframe} https://mediasite.bris.ac.uk/Mediasite/Play/775e60b933474d0aa2dbe0500716112f1d
:width: 100%
```
````
