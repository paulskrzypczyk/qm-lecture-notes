...
Interestingly, **the momentum wavefunction is also a complete specification of the state of a particle**. To see this, consider, just as we did in Sec.~\ref{s:arb init wf}, multiplying both sides of [](#e-psip) by $e^{ipx'/\hbar}$ and integrating over $p$, to obtain
\begin{align}
