...
At first sight, this appears like a major problem with the separation of variables method. Assuming a separable form, we found the most general solution to the Schr\"odinger equation, of the form [](#e-sep-form). This form is not normalisable for a free particle, hence it implies that our initial assumption, that the wavefunction was separable is inconsistent, and there are no stationary states for a free particle.
