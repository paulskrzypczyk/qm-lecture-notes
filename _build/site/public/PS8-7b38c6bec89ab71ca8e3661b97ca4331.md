...
1. In this question we will derive the result (4.23) from Example 4.1 in the notes (Gaussian wavepackets). Assume again a wavepacket of the form (4.14) (given above), with $c(k)$ given by the Gaussian function 
