...
1. Consider the following wavefunction,
  ...
  \end{equation}
   ...
   a.  Sketch the wavefunction $\Psi(x,t_0)$ and the probability density $P(x,t_0)$.
   a. What is the probability amplitude at $x = \frac{1}{2}$. 
   a. Where is the probability density to find the particle largest? What is the probability density there? 
